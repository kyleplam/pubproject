...
The purpose of this report is to understand intentions of family planning among women of different age groups in California. This is a descriptive type question in terms of the PPDAC framework. Our plan is to visualize the amount of in-hospital births between mothers of different age groups in California during 2008 and compare the amount of in-hospital births by the different age groups. We are using in-hospital births as a proxy for all births in California in 2008.
