...
The purpose of this report is to understand intentions of family planning among women of different age groups in California over the time period of 2008 to 2016. This is a descriptive type question in terms of the PPDAC framework. Our plan is to visualize the amount of in-hospital births between mothers of different age groups in California during 2008-2016. We are planning to observe any trends over time between the amount of births from mothers of different age groups between 2008-2016. We are using in-hospital births as a proxy for all births in California in 2008.
...
```{r}
old_births <- hospital_births_raw %>% filter(Age_Group == "Older Mothers (35 years 
  old or older)") %>% summarize(
  mean_old = mean(Count), 
...
We are estimating a categorical variable. 
...
The theoretical distribution does not apply to our project because we are working with a qualitative variable, not a quantitative variable.

## iii) Why is this an appropriate model for the data you are studying?

While we have no theoretical distribution, our bar chart from Problem 7 in Part 1 is an appropriate model for the data we are studying as it shows the intersection between the categorical variables.
...
In this demonstration, the statistical concept we will be showing is the conditional probabilities of the age groups given the years 2008 and 2016. We would like to compare these probabilities and to see if there is a difference over time. 
...
Using the total births of 2008 and 2016 calculated from the marginal probabilities, we find the conditional probability of a Teenage Mother giving birth in 2008 or 2016.
...
#Calculating Conditional Probability of Teenage Mother Giving Birth in 2008
probability_teen2008 <- teen_2008/total_2008 
probability_teen2008 <- probability_teen2008 %>% rename(probability_teen2008 = 
  sum_teen2008)

#Calculating Conditional Probability of Teenage Mother Giving Birth in 2016
...
Using the total births of 2008 and 2016 calculated from the marginal probabilities, we find the conditional probability of a Typical Aged Mother giving birth in 2008 or 2016.
...
#Calculating Conditional Probability of Typical Age Mother Giving Birth in 2008
...
#Calculating Conditional Probability of Typical Age Mother Giving Birth in 2016
...
Using the total births of 2008 and 2016 calculated from the marginal probabilities, we find the conditional probability of a Older Mothers giving birth in 2008 or 2016.
...
#Calculating Conditional Probability of Older Mothers Giving Birth in 2008
probability_old2008 <- old_2008/total_2008
probability_old2008 <- probability_old2008 %>% rename(probability_old2008 = sum_old2008 )

#Calculating Conditional Probability of Older Mothers Giving Birth in 2016
